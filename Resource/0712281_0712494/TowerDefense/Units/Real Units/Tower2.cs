...
namespace TowerDefense.Units.Real_Units
{
    public class Tower2 : Tower
    {
        ...
        public Tower2()
        {
            ...
            this._iSprite = 0;
            this._nSprite = Tower2.sNumSprite;
            this._iFirstSprite = Tower2.sBaseSprite;            

            this._nCost = Tower2.sCost;
            this._iMaxLife = Tower2.sMaxLife;
            this._iMaxEnergy = Tower2.sMaxEnergy;
            this._iBaseDamage = Tower2.sBaseDamage;
            this._iBaseAttackSpeed = Tower2.sBaseAttackSpeed;
            this._iBaseRange = Tower2.sBaseRange;
            this._damageType = Tower2.sDamageType;
            this._iBaseIntervalTime = Tower2.sIntervalTime;
        ...
        public Tower2(Vector2 vt2Position)
        {
        ...
        {
            Unit newTower = new Tower2(vt2Position);
