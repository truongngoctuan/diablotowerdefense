...
namespace TowerDefense.Units.Real_Units
{
    public class Tower4 : Tower
    {
        ...
        public Tower4()
        {
            ...
            this._iSprite = 0;
            this._nSprite = Tower4.sNumSprite;
            this._iFirstSprite = Tower4.sBaseSprite;            

            this._nCost = Tower4.sCost;
            this._iMaxLife = Tower4.sMaxLife;
            this._iMaxEnergy = Tower4.sMaxEnergy;
            this._iBaseDamage = Tower4.sBaseDamage;
            this._iBaseAttackSpeed = Tower4.sBaseAttackSpeed;
            this._iBaseRange = Tower4.sBaseRange;
            this._damageType = Tower4.sDamageType;
            this._iBaseIntervalTime = Tower4.sIntervalTime;
        ...
        public Tower4(Vector2 vt2Position)
        {
        ...
        {
            Unit newTower = new Tower4(vt2Position);
