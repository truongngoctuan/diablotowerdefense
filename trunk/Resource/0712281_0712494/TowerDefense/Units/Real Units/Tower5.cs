...
namespace TowerDefense.Units.Real_Units
{
    public class Tower5 : Tower
    {
        ...
        public Tower5()
        {
            ...
            this._iSprite = 0;
            this._nSprite = Tower5.sNumSprite;
            this._iFirstSprite = Tower5.sBaseSprite;            

            this._nCost = Tower5.sCost;
            this._iMaxLife = Tower5.sMaxLife;
            this._iMaxEnergy = Tower5.sMaxEnergy;
            this._iBaseDamage = Tower5.sBaseDamage;
            this._iBaseAttackSpeed = Tower5.sBaseAttackSpeed;
            this._iBaseRange = Tower5.sBaseRange;
            this._damageType = Tower5.sDamageType;
            this._iBaseIntervalTime = Tower5.sIntervalTime;
        ...
        public Tower5(Vector2 vt2Position)
        {
        ...
        {
            Unit newTower = new Tower5(vt2Position);
