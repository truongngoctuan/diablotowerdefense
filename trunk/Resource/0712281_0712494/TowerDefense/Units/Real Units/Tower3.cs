...
namespace TowerDefense.Units.Real_Units
{
    public class Tower3 : Tower
    {
        ...
        public Tower3()
        {
            ...
            this._iSprite = 0;
            this._nSprite = Tower3.sNumSprite;
            this._iFirstSprite = Tower3.sBaseSprite;            

            this._nCost = Tower3.sCost;
            this._iMaxLife = Tower3.sMaxLife;
            this._iMaxEnergy = Tower3.sMaxEnergy;
            this._iBaseDamage = Tower3.sBaseDamage;
            this._iBaseAttackSpeed = Tower3.sBaseAttackSpeed;
            this._iBaseRange = Tower3.sBaseRange;
            this._damageType = Tower3.sDamageType;
            this._iBaseIntervalTime = Tower3.sIntervalTime;
        ...
        public Tower3(Vector2 vt2Position)
        {
        ...
        {
            Unit newTower = new Tower3(vt2Position);
